package com.nutapos.crud.View;

import android.os.Bundle;

import com.nutapos.crud.Model.Player;
import com.nutapos.crud.Utils.CreatePlayerDialog;
import com.nutapos.crud.Utils.UpdatePlayerDialog;
import com.nutapos.crud.ViewModel.PlayerViewModel;
import com.nutapos.crud.R;
import com.nutapos.crud.Adapter.RecyclerViewAdapter;
...
public class MainActivity extends AppCompatActivity implements CreatePlayerDialog.CreatePlayerListener,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.delete_allPlayer:
                ...
                snackBar("Hapus Semua Stock Barang");
                return true;
            default:
    ...
    public void saveNewPlayer(Player player) {
        ...
        snackBar("Barang Baru Tersimpan");
    }
    ...
    public void updateNewPlayer(Player player) {
        ...
        snackBar("Barang Berhasil Diupdate");
    }
}
