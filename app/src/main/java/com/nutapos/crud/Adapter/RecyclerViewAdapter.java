package com.nutapos.crud.Adapter;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.RecyclerViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerViewHolder holder, int position) {
        ...
        holder.mName.setText("Nama Barang: "+currentPlayer.getName());
        holder.mAge.setText("Harga Jual: " +currentPlayer.getAge());
        holder.mPosition.setText("Harga Beli: " +currentPlayer.getPosition());
